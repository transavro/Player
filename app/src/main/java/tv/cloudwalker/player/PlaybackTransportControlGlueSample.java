...
class PlaybackTransportControlGlueSample<T extends PlayerAdapter> extends androidx.leanback.media.PlaybackTransportControlGlue<T> {
    ...
    private static final String TAG = "PbTransportControlGlue";
...
//        return action == mRepeatAction || action == mThumbsUpAction || action == mThumbsDownAction || action == mFastForwardAction || action == mRewindAction;
